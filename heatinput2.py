...
# ======================================================
# 3. WPS Range (left) | Live Result (right)
# ======================================================
st.write("")
range_col, live_col = st.columns([1.2, 1])
...
st.markdown(
    '<div class="footer">'
    '<img class="footer-logo-img" src="https://github.com/jubailsanghoon/HeatInput2/blob/main/db65c0d39f36f2dddc248ea0bf2e4efc.jpg?raw=true" />'
